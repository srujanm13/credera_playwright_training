...
const cusButton = await page.locator("xpath = //button[@id='addCustomerBtn']")
await cusButton.click();
await expect(cusButton).toBeVisible();
await expect(cusButton).toBeEnabled(); 
})
